...
public abstract class FormatConversionProvider {
     ...
     * returned.
     */
    public abstract SoundFormat.Encoding[] getSourceEncodings();
     ...
     * returned.
     */
    public abstract SoundFormat.Encoding[] getTargetEncodings();
     ...
     */
    public boolean isSourceEncodingSupported(SoundFormat.Encoding sourceEncoding){

        SoundFormat.Encoding sourceEncodings[] = getSourceEncodings();
     ...
     * @return <code>true</code> if the encoding is supported, otherwise <code>false</code>
     */
    public boolean isTargetEncodingSupported(SoundFormat.Encoding targetEncoding){

        SoundFormat.Encoding targetEncodings[] = getTargetEncodings();
     ...
     */
    public abstract SoundFormat.Encoding[] getTargetEncodings(SoundFormat sourceFormat);
     ...
     */
    public boolean isConversionSupported(SoundFormat.Encoding targetEncoding, SoundFormat sourceFormat){

        SoundFormat.Encoding targetEncodings[] = getTargetEncodings(sourceFormat);
     ...
     */
    public abstract SoundFormat[] getTargetFormats(SoundFormat.Encoding targetEncoding, SoundFormat sourceFormat);
     ...
     * @return <code>true</code> if the conversion is supported, otherwise <code>false</code>
     */
    public boolean isConversionSupported(SoundFormat targetFormat, SoundFormat sourceFormat){

        SoundFormat targetFormats[] = getTargetFormats( targetFormat.getEncoding(), sourceFormat );
     ...
     * not supported.
     */
    public abstract SoundInputStream getAudioInputStream(SoundFormat.Encoding targetEncoding, SoundInputStream sourceStream);
     ...
     * not supported.
     */
    public abstract SoundInputStream getAudioInputStream(SoundFormat targetFormat, SoundInputStream sourceStream);
