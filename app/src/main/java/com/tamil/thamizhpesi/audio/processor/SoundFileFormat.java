...
/**
 * An instance of the <code>SoundFileFormat</code> class describes
 ...
 * <p>
 * The <code>{@link SoundSystem}</code> class includes methods for determining the format
 * of an audio file, obtaining an audio input stream from an audio file, and
 * writing an audio file from an audio input stream.
 *
 * <p>An <code>SoundFileFormat</code> object can
...
public class SoundFileFormat {
     ...
     * @param byteLength the length of the file in bytes, or <code>-1</code>
     * @param format the format of the audio data contained in the file
     * @param frameLength the audio data length in sample frames, or <code>-1</code>
     *
     * @see #getType
     */
    protected SoundFileFormat(Type type, int byteLength, SoundFormat format, int frameLength) {
     ...
     * @param frameLength the audio data length in sample frames, or <code>-1</code>
     */
    public SoundFileFormat(Type type, SoundFormat format, int frameLength) {
     ...
     * @since 1.5
     */
    public SoundFileFormat(Type type, SoundFormat format,
     ...
     * the {@link SoundFileFormat class description}.
     *
    ...
    public String toString() {
        ...
        //$$fb2002-11-01: fix for 4672864: SoundFileFormat.toString() throws unexpected NullPointerException
        if (type != null) {
