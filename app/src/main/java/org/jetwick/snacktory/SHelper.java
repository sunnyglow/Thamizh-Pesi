...
public class SHelper {
    ...
    public static int countLetters(String str) {
        ...
        for (int i = 0; i < len; i++) {
            ...
            if (Character.isLetter(str.charAt(i)) || checkContains(str.charAt(i)+""))
                chars++;
        }
        return chars;
    }
    
    static String str[] = "ை,ி,ு,ெ,ொ,ா,ீ,ூ,ே,ோ,ௌ,்".split(",");
    
    public static boolean checkContains(String letter)
    {
